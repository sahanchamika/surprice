...
<body>
    <div class="sub_cat_dev">
            <div class="sub_cat_head">
                <h1>Price Range Selection</h1>
            </div>
            <div class="sub_cat_seach">
                    <input id="inputer" type="text" name="" placeholder="Enter price" onkeyup="search(this.value)">
                    <button type="button" class="pri_ran_butt">Set Price</button>
            </div>
            <div class="container">
                        ...
                        <?php
                            /*----------------all item tabel avalabel item-------------------*/
                                if(mysqli_num_rows($item_result) > 0){
                                    echo'<h1 class="item_cont_heder">Enter You Max Consideration</h1>';
...
<script type='text/javascript'>
    ...
    function search(str) {
        ...
        xmlhttp.open("GET","exphp/pricerageset.php?search="+str,true);
        xmlhttp.send();
    }
