...
$item = "SELECT * FROM item WHERE item_catagory_code='orn005' LIMIT 8";
...
<script type='text/javascript'>
    ...
    $(document).ready(function(){
            ...
            $(".boxed-btn4").click(function(){
                //pass count
                cou=cou+8;
                $("#item_content").load("exphp/onaloadmore.php",{
                    cou_N:cou
                });
            });
        });
    ...
    function search(str) {
        ...
        xmlhttp.open("GET","exphp/onasearch.php?search="+str,true);
        xmlhttp.send();
    }
