...
$item = "SELECT * FROM item WHERE item_catagory_code='sta004' LIMIT 8";
...
<script type='text/javascript'>
    ...
    $(document).ready(function(){
            ...
            $(".boxed-btn4").click(function(){
                //pass count
                cou=cou+8;
                $("#item_content").load("exphp/staloadmore.php",{
                    cou_N:cou
                });
            });
        });
    ...
    function search(str) {
        ...
        xmlhttp.open("GET","exphp/stasearch.php?search="+str,true);
        xmlhttp.send();
    }
