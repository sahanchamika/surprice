...
$item_id_pass = $_GET["item_id"];

/*----------------item loda-------------------*/
$item_diss = "SELECT * FROM item WHERE item_id='$item_id_pass' LIMIT 1";
...
<body>
<a href="catagory.php?page=all"><i class="fa fa-times" id="search_cancel"></i></a>
   <form  action="exphp/loaditemdis.php" method="post" >
                <?php
                 echo '<div class="item_ditails">
                    <div class="item_ditails_left_div">
                        <img class="item_ditails_img" src="'.$row['item_image'].'">
                        <div>
